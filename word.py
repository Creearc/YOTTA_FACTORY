...
for i in range(len(word)):
    tmp = {"name" : word[i], "x" : 4, "y" : 0, "z" : len(word) - i - 1}
    data.append(tmp)
    #print(tmp)

word = 'ведро'.upper()
for i in range(len(word)):
    tmp = {"name" : word[i], "x" : len(word) - i - 1, "y" : 0, "z" : 19}
    data.append(tmp)
    #print(tmp)
    
word = 'трансформаторостроение'.upper()
for i in range(len(word)):
    tmp = {"name" : word[i], "x" : 1, "y" : 0, "z" : 19 + len(word) - i - 1}
    data.append(tmp)
    #print(tmp)

word = 'генерал-квартирмейстер'.upper()
for i in range(len(word)):
    tmp = {"name" : word[i], "x" : 3, "y" : 0, "z" : 19 + len(word) - i - 1}
    data.append(tmp)
    #print(tmp)

word = 'человеконенавистничество'.upper()
for i in range(len(word)):
    tmp = {"name" : word[i], "x" : 2, "y" : 0, "z" : 40 + len(word) - i - 1}
    data.append(tmp)
    #print(tmp)

word = 'тога'.upper()
for i in range(len(word)):
    tmp = {"name" : word[i], "x" : 1 + len(word) - i - 1, "y" : 0, "z" : 40}
    data.append(tmp)
    #print(tmp)
...
##for i in range(len(word)):
##    tmp = {"name" : word[i], "x" : 1, "y" : 1, "z" : 19 + len(word) - i - 1}
##    data.append(tmp)
##    #print(tmp)
##
##word = 'трансформаторостроение'.upper()
##for i in range(len(word)):
##    tmp = {"name" : word[i], "x" : 3, "y" : 1, "z" : 19 + len(word) - i - 1}
##    data.append(tmp)
##    #print(tmp)
##
##word = 'генерал-квартирмейстер'.upper()
##for i in range(len(word)):
##    tmp = {"name" : word[i], "x" : 3, "y" : 3, "z" : 19 + len(word) - i - 1}
##    data.append(tmp)
##    #print(tmp)
##
##word = 'самоусовершенствование'.upper()
##for i in range(len(word)):
##    tmp = {"name" : word[i], "x" : 1, "y" : 3, "z" : 19 + len(word) - i - 1}
##    data.append(tmp)
##    #print(tmp)
##
##
